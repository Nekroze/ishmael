...
func init() {
	rootCmd.PersistentFlags().IntVar(&subcommands.Deadline, "wait", 1,
		"If given a positive integer then it will wait up to this many seconds for the subcommand to succeed.")
